...
class LoadShifting(Task):
    ...
    def store_shifted_loads(self, optimal_shifted_loads, exp_name, s3_url, aws_access, aws_secret):
    ...
    def run_load_shifting(self, preprocessed_data):
        ...
        self.store_shifted_loads(optimal_shifted_loads, config.DATA_SETTINGS.file_name, config.DATA_SETTINGS.s3_url, config.DATA_SETTINGS.aws_access, config.DATA_SETTINGS.aws_secret)
